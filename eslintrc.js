{
  ...
  "rules": {
    ...
    "no-console": 1, // disallow use of console (recommended)
    ...
    "key-spacing": [0, {"beforeColon": false, "afterColon": true}], // enforce spacing between keys and values in object literal properties
    ...
    // JSX-specific rules
    //
    "react/jsx-boolean-value": [0, "never"], // Enforce boolean attributes notation in JSX (fixable)
